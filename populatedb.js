...
async function createBodyTypes() {
    ...
    await Promise.all([
        ...
        bodyTypeCreate(3, "Hatchback"),
        bodyTypeCreate(4, "Roadster"),
        bodyTypeCreate(5, "Sports-car")
    ]);
}
...
async function createCars() {
    ...
    await Promise.all([
        carCreate(0, "Focus", 1998, 2018, bodyTypes[3], manufacturers[0], 1599, 4),
        carCreate(1, "Focus", 1998, 2018, bodyTypes[1], manufacturers[0], 1999, 2),
        carCreate(2, "Mustang", 1964, 2022, bodyTypes[5], manufacturers[0], 5000, 1),
        carCreate(3, "Golf", 1974, 2019, bodyTypes[3], manufacturers[1], 1299, 12),
        carCreate(4, "Polo", 1975, 2017, bodyTypes[3], manufacturers[1], 1499, 9),
        carCreate(5, "Arteon", 2017, 2017, bodyTypes[1], manufacturers[1], 1799, 0),
        carCreate(6, "A-Class", 2018, 2022, bodyTypes[3], manufacturers[2], 1999, 1),
        ...
        carCreate(10, "Z4", 2018, 2022, bodyTypes[4], manufacturers[3], 5599, 1),
        ...
        carCreate(16, "A1", 2010, 2018, bodyTypes[3], manufacturers[5], 2999, 5),
        ...
        carCreate(20, "Leaf", 2010, 2021, bodyTypes[3], manufacturers[6], 1599, 1),
        carCreate(21, "Altima", 1992, 2018, bodyTypes[1], manufacturers[6], 1999, 2),
        carCreate(22, "Note", 2004, 2024, bodyTypes[3], manufacturers[6], 1489, 4),
        ...
        carCreate(28, "MX-5", 1989, 2015, bodyTypes[4], manufacturers[7], 1999, 1),
        carCreate(29, "Colt", 1962, 2023, bodyTypes[3], manufacturers[7], 1699, 2),
